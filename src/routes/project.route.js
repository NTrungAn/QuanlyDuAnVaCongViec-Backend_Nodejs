...
router.post(
  ...
  agileController.addTaskToSprint,
);
router.put(
  "/:projectId/sprints/:sprintId",
  validate(updateSprintSchema),
  agileController.updateSprint,
);
...
router.post(
  ...
  agileController.createEpic,
);
router.post(
  "/:projectId/epics/:epicId/tasks",
  validate(linkTaskSchema),
  agileController.linkTaskToEpic,
);
router.put(
  "/:projectId/epics/:epicId",
  validate(updateEpicSchema),
  agileController.updateEpic,
);
